...
class Russia(object):
    ...
    def __init__(self):
        ...
        # 初始化颜色
        self.rec_1_next = (random.randint(10, 245), random.randint(10, 245), random.randint(10, 245))
        self.rec_2_next = (random.randint(10, 245), random.randint(10, 245), random.randint(10, 245))
        self.rec_3_next = (random.randint(10, 245), random.randint(10, 245), random.randint(10, 245))
        self.rec_4_next = (random.randint(10, 245), random.randint(10, 245), random.randint(10, 245))
        # 下边界
        for x in range(15):
        ...
        if isinstance(self.now_box, Beeline):
            ...
            if self.change_record == 0:
                for rect in self.border_fixed_rec:
                    ...
                    if pygame.rect.Rect(next_x1).colliderect(rect) or pygame.rect.Rect(next_x2).colliderect(rect) or pygame.rect.Rect(next_x3).colliderect(rect):
                        return
                self.rec_1[0] -= 30
                self.rec_1[1] += 30
                self.rec_3[0] += 30
    ...
    def create_new(self):
        ...
        self.rec_4_next = (random.randint(10, 245), random.randint(10, 245), random.randint(10, 245))
        # 创建下一个块
        self.small_1 = [rec_1[0]+630, rec_1[1]+190, 30, 30]
        self.small_2 = [rec_2[0]+630, rec_2[1]+190, 30, 30]
        self.small_3 = [rec_3[0]+630, rec_3[1]+190, 30, 30]
        self.small_4 = [rec_4[0]+630, rec_4[1]+190, 30, 30]
    ...
    def show_info(self):
        ...
        pygame.draw.lines(self.screen, (self.lines_color1, 0, self.lines_color3), True, [(1510, 340), (1690, 340), (1690, 390), (1510, 390)], 2)
        # 画出累计
        for rec in self.accumulate_list:
        ...
        if self.show_lines == 1:
            for x in range(14):
                pygame.draw.line(self.screen, (self.lines_color1, self.lines_color2, self.lines_color3), (711 + 30*x, 40), (711 + 30*x, 940), 1)
            for y in range(29):
                pygame.draw.line(self.screen, (self.lines_color1, self.lines_color2, self.lines_color3), (681, 68+30*y), (1132, 68+30*y), 1)
        # 画出排行榜
        # 画出边框
        pygame.draw.lines(self.screen, (250, 20, 50), False, [(400, 450), (400, 500), (160, 500), (160, 550), (400, 550), (400, 600), (160, 600), (160, 650)], 2)
        pygame.draw.line(self.screen, (250, 20, 50), (270, 450), (270, 650), 2)
        pygame.draw.lines(self.screen, (self.lines_color1, self.lines_color2, self.lines_color3), True, [(160, 450), (400, 450), (400, 650), (160, 650)], 3)
        # 表头和分数
    ...
    def began(self):
        while 1:
            ...
            # 下落
            if self.time_record % self.down_speed == 0 and self.pause == -1:
                self.move_down()
            # 显示
            self.show_info()
            self.draw_box()
